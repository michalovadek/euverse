...
# Inline-prose stats.
start_date <- fmt_date_nice(min(as.Date(veto_data$date_veto)))
...
prevalence of vetoes. Another source of underestimation is long-standing
...
p_a <- ggplot(df_a, aes(x = reorder(ms_veto, n), y = n,
  ...
  scale_fill_identity() +
  scale_y_continuous(breaks = int_breaks(8), expand = c(0, 0.1)) +
...
concerned and (since vetoes are frequently about foreign affairs) by
...
Ovádek, M. *euverse: Tracking EU Member States' Vetoes*. Accessed
