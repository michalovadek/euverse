...
Source data: [`data-manual/ms-vetoes.csv`](https://github.com/michalovadek/euverse/blob/main/data-manual/ms-vetoes.csv)
in the [euverse](https://github.com/michalovadek/euverse) repository.
The most recent veto recorded here is from
**`r format(max(as.Date(veto_data$date_veto)), "%d %B %Y")`**.

Cite as: Ovádek, M. *Tracking EU Member States' Vetoes*. Accessed
